...
#site_list = ['DELDIOS', 'FELICITA','KITCARSON','GREENVALLEY','MOONSONG']#'CLOVERDALE'
...
for site in site_list:
    ...
    if site == 'GREENVALLEY':
        level = df_all[df_all['Param']=='PT North'][['Datetime','Result']]
    ...
    ax1.set_ylim(0, level['Result'].max()*1.5)
